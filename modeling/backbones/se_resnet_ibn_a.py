...
class ResNet(nn.Module):
    ...
    def __init__(self, last_stride=1, block=SEBottleneck, layers=[3, 4, 6, 3]):
        self.inplanes = 64
    ...
    def forward(self, x):
        ...
        x3 = self.layer3(x2)
        x4 = self.layer4(x3)
#torch.Size([64, 256, 64, 32])
#torch.Size([64, 512, 32, 16])
#torch.Size([64, 1024, 16, 8])
#torch.Size([64, 2048, 16, 8])
        return [x1,x2,x3,x4]
